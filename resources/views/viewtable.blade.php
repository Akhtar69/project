        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Library Data</h5>
                            <div class="table-responsive">
                                <table  a href="{{ Route('showLibraryData') }}" class="table table-striped table-bordered table-sm"></a>
                                    <thead class="table text-white bg-dark table-sm">
                                        <tr>
                                            <th># No</th>
                                            <th>Name</th>
                                            <th>Book</th>
                                    ...
                                    @foreach ($ShowData as $key => $libraryData)

                                        <tbody class="table-hover table-bordered table-sm">
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $libraryData->Customer->name }}</td>
                                                <td>{{ $libraryData->Book->title }}</td>
                                                <td>{{ $libraryData->entry_date }}</td>
                                                <td>{{ $libraryData->from_date }}</td>
                                                <td>{{ $libraryData->to_date }}</td>
                                                <td>{{ $libraryData->no_of_days }}</td>
                                                <td>{{ $libraryData->rent }}</td>
                                                <td>{{ $libraryData->totalrent }}</td>

                                                <td>
                                                    <a class="btn btn-outline-primary"
                                                    href='edit/{{ $libraryData->id }}'

                                                        >Edit</a>
                                                    <a class="btn btn-outline-success"
                                                    href='delete/{{ $libraryData->id }}'
                                                    >Delete</a>
                                                </td>
                                            </tr>
