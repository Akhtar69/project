...
<head>
    ...
    <title>Welcome To Our Digital Library System</title>
    <!-- Favicon icon -->
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="form-basic.html" class="sidebar-link"><i
                                            class="mdi mdi-note-outline"></i><span class="hide-menu"> Data Submit
                                            Forms </span></a>
                                </li>
                                <li class="sidebar-item">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Data Submit Forms</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form action="{{ Route('submitBook') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="pages"
                                            class="col-sm-3 text-end control-label col-form-label">Pages</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="addition"
                                            class="col-sm-3 text-end control-label col-form-label">Addition</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="addition" placeholder="" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="price"
                                ...
                                <div class="form-group row">
                                    <label for="image" class="col-sm-3 text-end control-label col-form-label"
                                        style="margin:-20px 0 0px 0px;">Image</label>
                                    <div class="col-sm-9">
                                        <input type="file" name="image" class="form-control"
                                            style="width: 360px;margin:-20px 0 20px 10px;">
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-0">Booking Form</h5>
