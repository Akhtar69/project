            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                  ...
                  "
                        ...
                        <!-- Message -->
                        <a href="
                                            javascript:void(0)" class="link border-top">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action="{{ Route('updateLibraryData') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <h4 class="card-title">Data Update Form</h4>
                                    <div class="form-group row">
                                        <label for="name"
                                            class="col-sm-3 text-end control-label col-form-label">Name</label>
                                        <div class="col-sm-9">
                                            <input type="hidden" class="form-control" name="id" value="{{ $updatelibrarydata->id }}">
                                            <input type="text" class="form-control" name="name" value="{{ $updatelibrarydata->customer_id }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="book" class="col-sm-3 text-end control-label col-form-label">Book
                                            Name</label>
                                        <div class="col-sm-9">
                                            <select style="width:300px;" class="form-control" name="book"
                                                value="{{ $updatelibrarydata->title }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="entry_date" class="col-sm-3 text-end control-label col-form-label">
                                            Entry Date</label>
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" name="entry_date"
                                                value="{{ $updatelibrarydata->entry_date }}" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="from_date"
                                            class="col-sm-3 text-end control-label col-form-label">From Date</label>
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" name="from_date"
                                                value="{{ $updatelibrarydata->from_date }}" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="to_date" class="col-sm-3 text-end control-label col-form-label">To
                                            Date</label>
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" name="to_date"
                                                value="{{ $updatelibrarydata->to_date }}" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="days" class="col-sm-3 text-end control-label col-form-label">Total
                                            Days</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="days"
                                                value="{{ $updatelibrarydata->no_of_days }}" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="rent"
                                            class="col-sm-3 text-end control-label col-form-label">Rent</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="rent"
                                                value="{{ $updatelibrarydata->rent }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="renttotal"
                                            class="col-sm-3 text-end control-label col-form-label">Total Rent</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="renttotal"
                                                value="{{ $updatelibrarydata->totalrent }}" />
                                        </div>
                                    </div>
                                </div>
